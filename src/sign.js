...
function moverSinal(StopSinal) {
  var final = new THREE.Vector3(
    -1000,
    StopSinal.position.y,
    StopSinal.position.z,
  );

  var gravi = new THREE.Vector3(
    StopSinal.position.x,
    -1000,
    StopSinal.position.z,
  );
...
function addSinal() {
  ...
  var Material_Parede = new THREE.MeshPhongMaterial({
    color: 0x0000ff,
  ...
  importer1.load(
    "./assets/models/stopsign.fbx",
    function (StopSinal) {
      console.log("FBX carregou!"); // ← adiciona isto
